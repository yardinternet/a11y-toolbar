...
const options = {
 ...
 showOpenDyslexicButton: false,
 showTolkieTranslateButton: false,
 customButton: null,
 ...
 iconOptions: {
  ...
  tolkieTranslateIcon: 'flag', // The tolkieTranslateIcon option can be set to 'flag' to use the default flag icon, or it can be set to a FontAwesome icon class
 },
 textAfterOptions: {
  ...
  tolkieTranslateTextAfter: 'Vertalen',
 },
 labelOptions: {
